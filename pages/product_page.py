...
class ProductPage(BasePage):
    ...
    def should_be_add2cart_msg(self):   # Check Add2cart message
        ...
        product_added_msg = self.browser.find_element(*ProductPageLocators.ADD2CART_MSG).text
        assert self.is_element_present(*ProductPageLocators.PRODUCT_NAME), "Product name is missing"
        assert self.is_element_present(*ProductPageLocators.ADD2CART_MSG), "Add to cart message is missing"
